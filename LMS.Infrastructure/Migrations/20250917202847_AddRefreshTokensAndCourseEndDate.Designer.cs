...
namespace LMS.Infrastructure.Migrations
{
            ...
            [Migration("20250917202847_AddRefreshTokensAndCourseEndDate")]
            partial class AddRefreshTokensAndCourseEndDate
            {
                /// <inheritdoc />
...
#pragma warning disable 612, 618
                    ...
                    modelBuilder.Entity("LMS.Domain.Entities.Activity", b =>
                        {
                            b.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int");
                    ...
                    modelBuilder.Entity("LMS.Domain.Entities.Document", b =>
                        {
                            b.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int");
                    ...
                    modelBuilder.Entity("LMS.Domain.Entities.Course", b =>
                        {
                            b.HasOne("LMS.Domain.Entities.ApplicationUser", "Teacher")
                                .WithMany()
                    ...
                    modelBuilder.Entity("LMS.Domain.Entities.Document", b =>
                        {
                            b.HasOne("LMS.Domain.Entities.Activity", null)
                                .WithMany("Documents")
                                .HasForeignKey("ActivityId");
                            b.HasOne("LMS.Domain.Entities.Course", null)
                                .WithMany("Documents")
                                .HasForeignKey("CourseId");
                            b.HasOne("LMS.Domain.Entities.Module", null)
                                .WithMany("Documents")
                                .HasForeignKey("ModuleId");
                            b.HasOne("LMS.Domain.Entities.ApplicationUser", "UploadedByUser")
                                .WithMany()
                    ...
                    modelBuilder.Entity("LMS.Domain.Entities.RefreshToken", b =>
                        {
                            b.HasOne("LMS.Domain.Entities.RefreshToken", "ReplacedByToken")
                                .WithMany()
